...
const Register = (props: Props) => {
  ...
  const doRegister = async () => {
    await presenter.doAuth(() => presenter.register(alias, password, firstName, lastName, imageBytes, imageFileExtension), rememberMe, undefined);
  };
